...
export const onMainLoad = async ({
  ...
  const { playPause, next, previous, openSearchBox } = songControls;
  ...
  _registerLocalShortcut(window, 'CommandOrControl+F', openSearchBox);
  _registerLocalShortcut(window, 'CommandOrControl+L', openSearchBox);
